...
use Ortnit\Validator\Rule\AllAnd;
...
class AllAndTest extends TestCase
{
    public function getRule(): AllAnd
    {
        $rule = new AllAnd(new ObjectType(), new Instance(stdClass::class));
        $this->assertInstanceOf(AllAnd::class, $rule);
